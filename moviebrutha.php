	...
	function render_title_update()
	{
		...
		function handleFormSubmission()
		{
			...
			$postData = '{
			  ...
			  "Action": ' . ($genresArr[0] == 'true' ? 1 : 0) . ',
			  "Adventure": ' . ($genresArr[1] == 'true' ? 1 : 0) . ',
			  "Animation": ' . ($genresArr[2] == 'true' ? 1 : 0) . ',
			  "Biography": ' . ($genresArr[3] == 'true' ? 1 : 0) . ',
			  "Comedy": ' . ($genresArr[4] == 'true' ? 1 : 0) . ',
			  "Crime": ' . ($genresArr[5] == 'true' ? 1 : 0) . ',
			  "Documentary": ' . ($genresArr[6] == 'true' ? 1 : 0) . ',
			  "Drama": ' . ($genresArr[7] == 'true' ? 1 : 0) . ',
			  "Family": ' . ($genresArr[8] == 'true' ? 1 : 0) . ',
			  "Fantasy": ' . ($genresArr[9] == 'true' ? 1 : 0) . ',
			  "History": ' . ($genresArr[10] == 'true' ? 1 : 0) . ',
			  "Horror": ' . ($genresArr[11] == 'true' ? 1 : 0) . ',
			  "Music": ' . ($genresArr[12] == 'true' ? 1 : 0) . ',
			  "Musical": ' . ($genresArr[13] == 'true' ? 1 : 0) . ',
			  "Mystery": ' . ($genresArr[14] == 'true' ? 1 : 0) . ',
			  "Romance": ' . ($genresArr[15] == 'true' ? 1 : 0) . ',
			  "Sci_Fi": ' . ($genresArr[16] == 'true' ? 1 : 0) . ',
			  "Sport": ' . ($genresArr[17] == 'true' ? 1 : 0) . ',
			  "Thriller": ' . ($genresArr[18] == 'true' ? 1 : 0) . ',
			  "War": ' . ($genresArr[19] == 'true' ? 1 : 0) . ',
			  "Western": ' . ($genresArr[20] == 'true' ? 1 : 0) . '
			}';
